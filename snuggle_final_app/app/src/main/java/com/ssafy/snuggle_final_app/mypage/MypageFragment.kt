...
class MypageFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val menuCart = requireActivity().findViewById<View>(R.id.app_bar_cart) // Cart 버튼
        val menuNotification = requireActivity().findViewById<View>(R.id.app_bar_notification) // Notification 버튼
    ...
    override fun onResume() {
        ...
        val menuCart = requireActivity().findViewById<View>(R.id.app_bar_cart)
        val menuNotification = requireActivity().findViewById<View>(R.id.app_bar_notification)
        menuCart.setBackgroundColor(Color.parseColor("#FFE57D"))
        menuNotification.setBackgroundColor(Color.parseColor("#FFE57D"))
    }
