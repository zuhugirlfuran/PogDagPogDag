# 뜨개질 소품샵 어플(폭닥폭닥)
### ⭐싸피 12기 최종 관통 프로젝트 최우수상⭐
- 최종 관통 프로젝트: O2O 기반 스마트 스토어 시스템 - 스토어
- **팀명** : 즈후걸푸란
- **팀원** : 서정후, 김미경, 이승지
- **개발 기간** : 2024.11.19 ~ 2024.11.24(1주)
...
- **회원 가입**
    ...
    - 비밀번호 보이기/숨기기 기능
- **로그인**
    - 쿠키를 `sharedpreference`에 저장해 로그아웃 전까지 앱 실행시 로그인 유지
- **로그아웃**
    - 로그인 정보 삭제
