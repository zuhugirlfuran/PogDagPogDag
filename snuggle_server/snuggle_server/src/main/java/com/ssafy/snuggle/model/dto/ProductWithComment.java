...
public class ProductWithComment {
	...
	public ProductWithComment(Product product) {
		...
		this.commentId = product.getCommentId();
	...
	public String toString() {
		return "ProductWithComment [productId=" + productId + ", commentId=" + commentId + ", productName="
				+ productName + ", price=" + price + ", content=" + content + ", img=" + img + ", likeCount="
				+ likeCount + ", comments=" + comments + "]";
	}
