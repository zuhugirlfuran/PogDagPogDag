...
public interface FavoriteDao {
	...
	/**
	 * favorite 테이블에 정보를 추가한다. 좋아요를 누르면 해당 userId와 tagging_id를 받아 t_favorite에 추가한다.
	...
	/**
	 * favorite 삭제한다. 그리고 해당 상품의 likeCount를 1 감소시킨다.
	 * 
	 * @param userId, taggingId
	 * @return
	 */
	...
	/**
	 * 태깅 영상의 likeCount 갱신한다.
	 */
	void updateLikeCount(String tagggingId);
